...
export function ProductsPage() {
  ...
  const updatePath = (pageVal: string | number, idVal: string | number, searchVal: string) => {
    window.history.replaceState(null, '', `/products/page=${pageVal}/id=${idVal}/search=${searchVal}`);
  };
